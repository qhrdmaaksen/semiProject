...
public class Paging2 {
	//페이징 관련 변수
		...
		private String pagingDateHtml = "";//하단의 숫자 페이지 링크
		...
		public Paging2(
			...
			this.pagingDateHtml = this.getPagingPointHtml( url ) ;
		...
		public String getPagingPointHtml(String url){ //페이징 문자열을 만든다.
			String result = "" ;
		...
		public String getPagingPointHtml() { return pagingDateHtml; }
